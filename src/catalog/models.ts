...
export const MODELS_BY_PROVIDER: Record<string, ModelSpec[]> = {
  ...
  auriko: [
    ...
    m("glm-4.6v-flash", "128K", "General", 3),
  ...
  literouter: [
    m("deepseek-r1:free", "128K", "Reasoning", 2),
  ...
  "llm-kiwi": [m("auto", undefined, "General", 1), m("hrLLM", undefined, "General", 2.4)],
  llm7: [
    m("codestral-latest", "32K", "Code", 1),
  ...
  meganova: [
    ...
    m("Sao10K/L3-8B-Stheno-v3.2", "8K", "General", 1),
  ],
  mistral: [
  ...
  mixlayer: [m("qwen/qwen3.5-4b-free", "131K", "General", 1)],
  modelscope: [
  ...
  nvidia: [
    m("meta/llama-3.2-11b-vision-instruct", "128K", "Vision", 1),
    ...
    m("openai/gpt-oss-20b", "131K", "General", 2),
  ...
  odirouter: [
    ...
    m("free-minimax-m2.7", "200K", "Reasoning", 4),
  ...
  ollama: [
    ...
    m("nemotron-3-super", "256K", "General", 2),
  ...
  openrouter: [
    ...
    m("poolside/laguna-s-2.1:free", "256K", "Code", 2),
    m("poolside/laguna-xs-2.1:free", "128K", "Code", 1.9),
  ],
  orcarouter: [
  ...
  poixe: [
    ...
    m("o3-mini-2025-01-31:free", "128K", "Reasoning", 3),
  ...
  voidai: [
    m("deepseek-v3.2", "128K", "Reasoning", 2),
    ...
    m("glm-5.2", "128K", "General", 2),
    m("glm-5.3", "128K", "General", 2),
