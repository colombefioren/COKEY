...
export const MODELS_BY_PROVIDER: Record<string, ModelSpec[]> = {
  ...
  xkiro: [
    m("openai/gpt-5.3-codex-spark", "128K", "Code"),
    m("mistralai/mistral-large-2512", "256K", "Reasoning"),
    m("mistralai/mistral-medium-3.5", "256K", "General"),
    m("mistralai/mistral-small-2603", "256K", "Code"),
    m("mistralai/codestral-2508", "256K", "Code"),
    m("mistralai/devstral-medium", "256K", "Code"),
    m("mistralai/ministral-14b", "256K", "General"),
    m("mistralai/ministral-8b", "256K", "General"),
    m("mistralai/ministral-3b", "128K", "General"),
    m("minimax/minimax-m3:free", "1M", "General"),
    m("minimax/minimax-m2.7:free", "204K", "General"),
    m("minimax/minimax-m2.7-highspeed:free", "204K", "General"),
    m("minimax/minimax-m2.5:free", "204K", "Code"),
    m("minimax/minimax-m2.5-highspeed:free", "204K", "Code"),
    m("minimax/minimax-m2.1:free", "204K", "Code"),
    m("minimax/minimax-m2.1-highspeed:free", "204K", "Code"),
    m("minimax/minimax-m2:free", "204K", "Agent"),
    m("deepseek/deepseek-v4.1-flash:free", "1M", "Reasoning"),
    m("deepseek/deepseek-v4-pro", "1M", "Reasoning"),
    m("deepseek/deepseek-v4-flash", "1M", "Reasoning"),
    m("deepseek/deepseek-v3.2", "131K", "Reasoning"),
    m("deepseek/deepseek-chat-v3.1", "163K", "Reasoning"),
    m("sensenova/sensenova-6.8-flash-lite", "262K", "General"),
    m("sensenova/sensenova-6.7-flash-lite", "262K", "General"),
    m("qwen/qwen3.8-max:free", "1M", "General"),
    m("qwen/qwen3.7-max:free", "1M", "General"),
    m("qwen/qwen3.7-plus:free", "1M", "General"),
    m("qwen/qwen3.6-plus:free", "1M", "General"),
    m("qwen/qwen3.5-plus:free", "1M", "General"),
    m("qwen/qwen3.5-omni-plus:free", "262K", "Vision"),
    m("qwen/qwen3.5-flash:free", "1M", "General"),
    m("qwen/qwen3.5-omni-flash:free", "262K", "Vision"),
    m("qwen/qwen3-max:free", "262K", "General"),
    m("qwen/qwen-plus-2025-07-28:free", "131K", "General"),
    m("qwen/qwen3-coder-plus:free", "1M", "Code"),
    m("qwen/qwen3-vl-plus:free", "262K", "Vision"),
    m("qwen/qwen3-omni-flash:free", "262K", "Vision"),
  ],
