export const FR: Record<string, string> = {
  ...
  "Move this chain up": "Déplacer cette chaîne vers le haut",
  "Move this chain down": "Déplacer cette chaîne vers le bas",
  "Chains themselves are ordered here too — the dashboard lists them in this order.":
    "Les chaînes elles-mêmes sont ordonnées ici aussi — le tableau de bord les liste dans cet ordre.",
